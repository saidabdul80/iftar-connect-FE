<template>
    <v-btn @click="showReservations()" size="small" style="padding:6px;width: 28px !important;height:28px !important; border-radius:20px; position:absolute;top:60px;right: 60px;font-size: 0.8em;" class="bg-orange text-white d-flex justify-center align-center">{{ store.beneficiary?.reservation_ids?.length }}</v-btn>
                ...
                <div class="shadow d-flex rounded-lg pa-2 position-relative" >
                    ...
                    <div>
                        ...
                        <div class="display-type">
                            <p><span color="#F5891B" class="heading-x ">Date: Today </span><span class="content-x">{{ meal?.time_slot }}</span></p>
